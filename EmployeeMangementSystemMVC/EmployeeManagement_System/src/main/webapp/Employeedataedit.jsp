...
<body>
	...
	<div class="container">
		<div id="emp1">
			...
			<a id="employee_id" href="Employeedataedit.jsp">Employees</a><br>
		</div>
	...
	<div id="emp">
		<div class="contaner1">
			<c:set var="ob" value="${update_e}" />
			<form action="/editemp/${ob.id}" method="post">
				Id <input type="hidden" name=id value='${ob.id }'> Name <input
				...
				department<input type="text" name=department
					value='${ob.department }'> role<input type="text" name=role
					value='${ob.role }'> phone<input type="text" name=phone
					value='${ob.phone }'>
