...
<body>
	...
	<div class="container">
		<div id="emp1">
			...
			<a id="employee_id" href="login.jsp">Employees</a><br>
		</div>
	...
	<div id="emp">
		<div class="contaner1">
			<form action="register" method="post" onsubmit="func()">
				<div id="heading">
					<h1>Registration</h1>
				</div>
				<c:if var="od" test="${not empty msg}">
					<h5>${msg}</h5>
					<c:remove var="msg" />
				</c:if>
				...
				<h5 Style="margin-bottom: 5px; ">
					Already have an register?<a href="Employeehome.jsp">Login In</a>
				</h5>
			</form>
          <% %>
