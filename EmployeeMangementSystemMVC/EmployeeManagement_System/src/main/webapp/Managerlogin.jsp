...
<div class="container">
    <div id="emp1">
       <i id="employee" class="fa-solid fa-user-tie" title="manger"></i><br><a id="employee_id" href="Managerlogin.jsp">Manager</a><br> 
   </div>
 ...
 <div id="emp">
         <div class="contaner1">
		       <form action="managerlogin" method="post">
				...
				<h5>Don't have an account?<a href="Managerhome.jsp" style="border:none;background:none;padding:0px;color:blue;margin: 0px;box-shadow: none; text-decoration: none; ">Register</a></h5>
