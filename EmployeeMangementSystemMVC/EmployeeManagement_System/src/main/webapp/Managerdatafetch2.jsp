...
<body>
	...
	<div id="emp">
	 ...
	 <c:forEach var="ob" items="${Data_ml}">
		       <h1 style="padding: 0px; margin: 0px;position: absolute;top:100px;left: 750px; ">Manager Detial</h1>
				<table border="2">
					<tr>
						<th>Manager_id:</th><td>${ob.id }</td>
						
					</tr>
					
					<tr>
					<th>Name:</th><td>${ob.name }</td>	
					</tr>
					<tr>
					<th>Email:</th>	<td>${ob.email }</td>
					</tr>
					<tr>
					<th>Password:</th><td>${ob.password }</td>
					</tr>
					<tr>
					<th>Birth Date:</th><td>${ob.birthdate }</td>
					</tr>
					<tr>
					<th>Description:</th><td>${ob.decription }</td>
					</tr>
					<tr>
						<th>Phone:</th><td>${ob.phone }</td>
					</tr>
				</table>
				<a class="del" href="<c:url value='/delete1/${ob.id}'/>">Delete</a>
				<a class="del1" href="<c:url value='/ed/${ob.id}'/>">Edit</a>
			</c:forEach>
	 </div>
