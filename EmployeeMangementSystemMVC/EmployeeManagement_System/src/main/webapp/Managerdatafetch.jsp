...
<body>
	...
	<div class="container">
		<div id="emp1">
			...
			<a id="employee_id" href="Managerdatafetch.jsp">Manager</a><br>
		</div>
		<hr width="60%" size="2" color="#000">
		<br> <a id="employee_id1" href="Home.jsp"><i
			class="fa-solid fa-house"></i>Home</a><br><br><br><br>
		<h2> <a  style="text-decoration: none; color: green; font-family:fantasy; margin-left: 65px;" href="/Alldata">All Employeedata</a></h2>

	</div>
	<div id="emp">
	 <div class="contaner1">
		<c:forEach var="emp" items="${Data_m }">
		       <h1 style="padding: 0px; margin: 0px;position: absolute;top:100px;left: 750px; ">Manager Detial</h1>
				<table border="2">
					<tr>
						<th>Manager_id:</th><td>${emp.id }</td>
					...
					<tr>
					<th>Password:</th><td>${emp.password }</td>
					</tr>
					<tr>
					<th>Birth Date:</th><td>${emp.birthdate }</td>
					</tr>
					<tr>
					<th>Description:</th><td>${emp.decription }</td>
					</tr>
					<tr>
						<th>Phone:</th><td>${emp.phone }</td>
					</tr>
					
				</table>
				<a class="del" href="<c:url value='/delete1123/${emp.id}'/>">Delete</a>
				<a class="del1" href="<c:url value='/ed/${emp.id}'/>">Edit</a>
			</c:forEach>
